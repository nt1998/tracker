      ...
      <div className="chart-card">
        <ScrubbableLine
          data={{
            labels,
            datasets: [
              { label: 'Fat', data: fatMass, borderColor: '#fab387', backgroundColor: hexToRgba('#fab387', 0.12), fill: false },
              { label: 'Muscle', data: muMass, borderColor: '#a6e3a1', backgroundColor: hexToRgba('#a6e3a1', 0.12), fill: false },
            ],
          }}
          options={journeyOpts()}
          width={CANVAS_W} height={140}
